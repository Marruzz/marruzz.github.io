        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-center lg:text-left animate-fade-in">
              ...
              <p class="text-lg text-gray-500 mb-8 max-w-2xl lg:max-w-none leading-relaxed">
            ...
            <div class="text-center animate-slide-left">
              ...
              <div class="grid grid-cols-3 gap-4 max-w-md mx-auto">
                <div class="bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-lg text-center border border-gray-100">
                  <div class="text-2xl font-bold text-primary">17</div>
                  <div class="text-sm text-gray-600">Anni</div>
                </div>
                <div class="bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-lg text-center border border-gray-100">
                  <div class="text-2xl font-bold text-primary">8+</div>
                  <div class="text-sm text-gray-600">Linguaggi</div>
                </div>
                <div class="bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-lg text-center border border-gray-100">
                  <div class="text-2xl font-bold text-primary">15+</div>
                  <div class="text-sm text-gray-600">Progetti</div>
                </div>
              </div>
            </div>
          </div>
