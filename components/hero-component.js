  ...
  connectedCallback() {
    this.innerHTML = `
      <section id="home" class="pt-16 min-h-screen flex items-center relative overflow-hidden" role="banner" aria-label="Sezione Hero - Presentazione">
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-indigo-50 via-white to-purple-50 transition-colors duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          <div class="grid lg:grid-cols-2 gap-12 items-center">            
            <div class="text-center lg:text-left">
              ...
              <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 transition-colors duration-300 animate-slide-up">
                Ciao, sono
                <span class="gradient-text typing-cursor block mt-2">Luca Marroni</span>
              </h1>
              
              <p class="text-xl md:text-2xl text-gray-600 transition-colors duration-300 animate-slide-up animate-stagger-1">
                <i class="fas fa-code mr-2 text-primary" aria-hidden="true"></i>
                Developer Full-Stack & Studente
              </p>
              
              <p class="text-lg text-gray-500 transition-colors duration-300">
              ...
              <div class="flex justify-center lg:justify-start space-x-6" role="list" aria-label="Link ai social media">
                <a href="https://github.com/Marruzz/" 
                   ...
                   class="text-gray-400 transition-all duration-300 transform hover:scale-110 focus:ring-4 focus:ring-primary/50 rounded-lg p-2"
            ...
            <div class="text-center animate-slide-left">
              ...
              <div class="grid grid-cols-3 gap-4 max-w-md mx-auto">
                <div class="glass-card bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-lg text-center border border-gray-100 transition-colors duration-300"
                     role="img"
