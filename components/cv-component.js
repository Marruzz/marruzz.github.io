class CVComponent extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
        <section id="cv"
            class="py-20 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 relative overflow-hidden transition-colors duration-300">

            <div
                class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-primary/5 to-purple-600/5 rounded-full blur-3xl">
            </div>
            <div class="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-accent/5 to-pink-500/5 rounded-full blur-3xl">
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                    <div class="animate-slide-right">
                        <div
                            class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                            ...
                            <div class="p-8">
                                <div class="space-y-4 mb-8">
                                    <div class="flex items-center text-gray-600 dark:text-gray-100">
                                        ...
                                        <span class="dark:text-gray-100"><strong class="dark:text-white">Lingua:</strong>
                                            Italiano</span>
                                    </div>
                                    <div class="flex items-center text-gray-600 dark:text-gray-100">
                                        <i class="fas fa-file-alt text-primary mr-3"></i>
                                        <span class="dark:text-gray-100"><strong class="dark:text-white">Formato:</strong>
                                            PDF</span>
                                    </div>
                                    <div class="flex items-center text-gray-600 dark:text-gray-100">
                        ...
                        <div
                            ...
                            <div class="p-8">
                                <div class="space-y-4 mb-8">
                                    <div class="flex items-center text-gray-600 dark:text-gray-100">
                                        <i class="fas fa-language text-primary mr-3"></i>
                                        <span class="dark:text-gray-100"><strong class="dark:text-white">Language:</strong>
                                            English</span>
                                    </div>
                                    <div class="flex items-center text-gray-600 dark:text-gray-100">
                                        <i class="fas fa-file-alt text-primary mr-3"></i>
                                        <span class="dark:text-gray-100"><strong class="dark:text-white">Format:</strong>
                                            PDF</span>
                                    </div>
                                    <div class="flex items-center text-gray-600 dark:text-gray-100">
                                        <i class="fas fa-calendar text-primary mr-3"></i>
                ...
                <div class="mt-20 animate-fade-in">
                    <div
                        class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 lg:p-12 transition-colors duration-300">
                        <div class="text-center mb-12">
                            ...
                            <p class="text-gray-600 dark:text-gray-100 text-lg transition-colors duration-300">
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <div class="text-center group">
                                <div
                                    class="bg-gradient-to-br from-primary/10 to-purple-600/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                                    <i class="fas fa-graduation-cap text-primary text-2xl"></i>
                                </div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 transition-colors duration-300">
                                    Formazione</h4>
                                <p class="text-gray-600 dark:text-gray-100 text-sm transition-colors duration-300">ITIS
                                    E.Majorana<br>Informatica & Telecomunicazioni</p>
                            </div>

                            <div class="text-center group">
                                <div
                                    class="bg-gradient-to-br from-accent/10 to-orange-500/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                                    <i class="fas fa-certificate text-accent text-2xl"></i>
                                </div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 transition-colors duration-300">
                                    Certificazioni</h4>
                                <p class="text-gray-600 dark:text-gray-100 text-sm transition-colors duration-300">CISCO IT
                                    Essentials<br>Competenze Tecniche</p>
                            </div>
                            ...
                            <div class="text-center group">
                                ...
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 transition-colors duration-300">
                                    Competenze</h4>
                                <p class="text-gray-600 dark:text-gray-100 text-sm transition-colors duration-300">JavaScript,
                                    Angular<br>.NET MAUI, Python</p>
                            </div>
                            ...
                            <div class="text-center group">
                                ...
                                <h4 class="font-bold text-gray-900 dark:text-white mb-2 transition-colors duration-300">Progetti
                                </h4>
                                <p class="text-gray-600 dark:text-gray-100 text-sm transition-colors duration-300">Portfolio
                                    Diversificato<br>Soluzioni Innovative</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-16 text-center animate-fade-in">
                    <div class="bg-gradient-to-r from-primary to-purple-600 rounded-3xl p-8 text-white">
