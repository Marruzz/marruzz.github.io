...
class PCTOComponent extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      <section id="pcto"
    class="py-20 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-blue-900 relative overflow-hidden transition-colors duration-300">
    <!-- Background decorations -->
    <div
        class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-blue-500/10 to-indigo-600/10 rounded-full blur-3xl">
    </div>
    <div
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="text-center mb-16 animate-fade-in">
            <span
                class="inline-block bg-blue-600/10 text-blue-600 dark:text-blue-400 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            <p class="text-xl text-gray-600 dark:text-gray-100 mt-6 max-w-3xl mx-auto transition-colors duration-300">
                Il mio percorso di alternanza scuola-lavoro con esperienze formative, progetti innovativi e competenze
                acquisite sul campo.
            </p>
        </div> <!-- Dashboard Statistiche -->
        <div class="grid md:grid-cols-3 gap-6 mb-16 animate-slide-up">
            <div
                class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-700 text-center group hover:scale-105 transition-all duration-300">
                <div
                    class="bg-gradient-to-br from-blue-500 to-blue-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
            ...
            <div
                class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-700 text-center group hover:scale-105 transition-all duration-300">
                <div
                    class="bg-gradient-to-br from-purple-500 to-purple-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                    <i class="fas fa-project-diagram text-white text-2xl"></i>
                </div>
                <h3 class="text-3xl font-bold text-purple-600 mb-2">
                    ${Object.values(pctoData.attivitaPerAnno).reduce((sum, anno) => sum + anno.length, 0)}</h3>
            ...
            <div
                class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-700 text-center group hover:scale-105 transition-all duration-300">
                <div
                    class="bg-gradient-to-br from-orange-500 to-orange-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
        ...
        <div class="mb-16 animate-slide-right">
            <div
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <span
                        class="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-4 py-2 rounded-full text-sm font-semibold">
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div class="animate-slide-left">
                <div
                    ...
                    <div class="flex items-center mb-6">
                        <div
                            class="bg-gradient-to-br from-blue-500 to-blue-600 w-12 h-12 rounded-full flex items-center justify-center mr-4">
                    ...
                    <div class="space-y-4">
                        <div
                            class="pcto-activity-card bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 p-4 rounded-xl border border-red-200 dark:border-red-800">
                            <div class="flex justify-between items-center">
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">Corso Sicurezza</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Formazione base sulla sicurezza
                                    </p>
                                </div>
                        ...
                        <div
                            class="pcto-activity-card bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-4 rounded-xl border border-purple-200 dark:border-purple-800">
                            <div class="flex justify-between items-center">
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">Coding nelle Scuole Primarie
                                    </h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Insegnamento programmazione base
                                    </p>
                                </div>
                                <div class="text-right">
                        ...
                        <div
                            class="pcto-activity-card bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 p-4 rounded-xl border border-blue-200 dark:border-blue-800">
                            <div class="flex justify-between items-center">
                                <div>
                        ...
                        <div
                            class="pcto-activity-card bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-4 rounded-xl border border-green-200 dark:border-green-800">
                            <div class="flex justify-between items-center">
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">Olimpiadi CyberSecurity</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Competizione sicurezza
                                        informatica</p>
                                </div>
                                <div class="text-right">
                        ...
                        <div
                            class="pcto-activity-card bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 p-4 rounded-xl border border-yellow-200 dark:border-yellow-800">
                            <div class="flex justify-between items-center">
                                <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div
                                class="pcto-activity-card bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 p-3 rounded-xl border border-indigo-200 dark:border-indigo-800">
                            ...
                            <div
                                class="pcto-activity-card bg-gradient-to-r from-gray-50 to-slate-50 dark:from-gray-900/20 dark:to-slate-900/20 p-3 rounded-xl border border-gray-200 dark:border-gray-800">
                    ...
                    <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-xl">
                        <p class="text-sm text-blue-800 dark:text-blue-200 font-medium">
                            ...
                            Totale 3° Anno: <strong>140 ore svolte</strong>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="animate-slide-right">
                <div
                    ...
                    <div class="flex items-center mb-6">
                        <div
                            class="bg-gradient-to-br from-green-500 to-green-600 w-12 h-12 rounded-full flex items-center justify-center mr-4">
                    ...
                    <div class="space-y-4">
                        <div
                            class="pcto-activity-card bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 p-4 rounded-xl border border-red-200 dark:border-red-800">
                            <div class="flex justify-between items-center">
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">Madrid</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Esperienza lavorativa
                                        internazionale</p>
                                </div>
                                <div class="text-right">
                        ...
                        <div
                            class="pcto-activity-card bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-4 rounded-xl border border-blue-200 dark:border-blue-800">
                            <div class="flex justify-between items-center">
                                <div>
                                ...
                                <div class="text-right">
                                    <span class="text-2xl font-bold text-blue-600">112</span>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">ore svolte</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">Debate</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Competenze comunicative avanzate
                                    </p>
                                </div>
                                <div class="text-right">
                                    <span class="text-2xl font-bold text-yellow-600">40</span>
                        ...
                        <div
                            class="pcto-activity-card bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 p-4 rounded-xl border border-purple-200 dark:border-purple-800">
                            <div class="flex justify-between items-center">
                                <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div
                                class="pcto-activity-card bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-3 rounded-xl border border-green-200 dark:border-green-800">
                        ...
                        <div
                            class="pcto-activity-card bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 p-3 rounded-xl border border-orange-200 dark:border-orange-800">
                            <h4 class="font-semibold text-gray-900 dark:text-white text-sm">PoliTo - Corso "Leadership
                                Digitale</h4>
                    ...
                    <div class="mt-6 p-4 bg-green-50 dark:bg-green-900/30 rounded-xl">
                        <p class="text-sm text-green-800 dark:text-green-200 font-medium">
                            <i class="fas fa-info-circle mr-2"></i>
                            Totale 4° Anno: <strong>297 ore svolte</strong>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="text-center group">
                        <div
                            class="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                    ...
                    <div class="text-center group">
                        <div
                            class="bg-gradient-to-br from-green-500/10 to-emerald-500/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                    ...
                    <div class="text-center group">
                        <div
                            class="bg-gradient-to-br from-purple-500/10 to-pink-500/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                    ...
                    <div class="text-center group">
                        <div
                            class="bg-gradient-to-br from-orange-500/10 to-red-500/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
        ...
        <div class="text-center animate-fade-in">
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-8 text-white">
                ...
                <p class="text-xl mb-6 opacity-90">
                    Un'esperienza formativa che ha consolidato competenze tecniche, soft skills e una visione del mondo
