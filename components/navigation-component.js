  ...
  connectedCallback() {
    this.innerHTML = `
      <nav class="bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-lg fixed w-full top-0 z-50 border-b border-gray-100 dark:border-gray-800 transition-colors duration-300">
        ...
        <!-- Mobile menu -->
        <div id="mobile-menu" class="md:hidden hidden bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-t border-gray-100 dark:border-gray-800 transition-colors duration-300">          <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
