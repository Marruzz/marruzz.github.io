        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="animate-slide-right">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8 stagger-group">
                    <div
                        class="flex items-center bg-gradient-to-r from-primary/10 to-purple-600/10 p-4 rounded-xl border border-primary/20 animate-slide-left animate-stagger-1 hover-lift">
                    ...
                    <div
                        class="flex items-center bg-gradient-to-r from-accent/10 to-orange-500/10 p-4 rounded-xl border border-accent/20">
                    ...
                    <div
                        class="flex items-center bg-gradient-to-r from-green-500/10 to-emerald-500/10 p-4 rounded-xl border border-green-500/20">
                    ...
                    <div
                        class="flex items-center bg-gradient-to-r from-blue-500/10 to-cyan-500/10 p-4 rounded-xl border border-blue-500/20">
            ...
            <div class="animate-slide-left">
                ...
                <div
                    class="bg-gradient-to-br from-primary/5 to-purple-600/5 p-8 rounded-3xl border border-primary/10 shadow-xl mb-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm">
                            ...
                            <span
                                class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-semibold">Madrelingua</span>
                        </div>
                        <div class="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm">
                            <div class="flex items-center">
                            ...
                            <span
                                class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-semibold">C1</span>
                        </div>
                        <div class="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm">
                            <div class="flex items-center">
                            ...
                            <span
                                class="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm font-semibold">A2</span>
                        </div>
                    </div>
                </div>
